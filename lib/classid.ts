...
// whitespace, or vary in case). Both call sites MUST run their raw label
// through this before calling makeClassId(), otherwise the pilots and
// classes rows won't share a classid and nothing joins.
//
