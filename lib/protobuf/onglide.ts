...
export interface SpeedDist {
    ...
    grRemaining?: number | undefined;
    /** speed on this leg */
    legSpeed?: number | undefined;
...
export interface PilotScore {
    ...
    taskTimeRemaining?: number | undefined;
    /** bool startFound = 6; */
...
export const OnglideWebSocketMessage = {
    ...
    fromPartial<I extends Exact<DeepPartial<OnglideWebSocketMessage>, I>>(object: I): OnglideWebSocketMessage {
        const message = createBaseOnglideWebSocketMessage();
        message.identifiers = object.identifiers !== undefined && object.identifiers !== null ? Identifiers.fromPartial(object.identifiers) : undefined;
        ...
        message.positions = object.positions !== undefined && object.positions !== null ? ClassPositions.fromPartial(object.positions) : undefined;
...
export const PilotScoreLeg = {
    ...
    fromPartial<I extends Exact<DeepPartial<PilotScoreLeg>, I>>(object: I): PilotScoreLeg {
        ...
        message.point = object.point !== undefined && object.point !== null ? BasePositionMessage.fromPartial(object.point) : undefined;
...
export const Stats = {
    ...
    fromJSON(object: any): Stats {
        return {
            segments: globalThis.Array.isArray(object?.segments) ? object.segments.map((e: any) => StatSegment.fromJSON(e)) : []
        };
    },
...
export const PilotScore = {
    ...
    fromJSON(object: any): PilotScore {
        return {
            ...
            wind: isSet(object.wind) ? Wind.fromJSON(object.wind) : undefined,
            scoredPoints: globalThis.Array.isArray(object?.scoredPoints) ? object.scoredPoints.map((e: any) => globalThis.Number(e)) : [],
            minDistancePoints: globalThis.Array.isArray(object?.minDistancePoints) ? object.minDistancePoints.map((e: any) => globalThis.Number(e)) : [],
            maxDistancePoints: globalThis.Array.isArray(object?.maxDistancePoints) ? object.maxDistancePoints.map((e: any) => globalThis.Number(e)) : [],
...
export const PilotScore_LegsEntry = {
    ...
    fromPartial<I extends Exact<DeepPartial<PilotScore_LegsEntry>, I>>(object: I): PilotScore_LegsEntry {
        ...
        message.value = object.value !== undefined && object.value !== null ? PilotScoreLeg.fromPartial(object.value) : undefined;
        return message;
    }
};
...
export const Positions = {
    ...
    fromJSON(object: any): Positions {
        return {
            positions: globalThis.Array.isArray(object?.positions) ? object.positions.map((e: any) => PilotPosition.fromJSON(e)) : []
        };
    },
...
export const ClassPositions_ClassEntry = {
    ...
    fromPartial<I extends Exact<DeepPartial<ClassPositions_ClassEntry>, I>>(object: I): ClassPositions_ClassEntry {
        const message = createBaseClassPositions_ClassEntry();
        message.key = object.key ?? '';
        message.value = object.value !== undefined && object.value !== null ? Positions.fromPartial(object.value) : undefined;
        return message;
    }
};
