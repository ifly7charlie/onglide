...
export function updateSortKeys(trackers,sortKey,units,now) {

    function updatePilotSortKey(tracker,sortKey,units,now) {
    ...
    _foreach( trackers, (tracker) => {
        updatePilotSortKey( tracker, sortKey, units, now );
    });
}
