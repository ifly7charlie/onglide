...
import { useTaskGeoJSON, usePilotsGeoJSON, usePilotFullGeoJSON, Spinner, Error } from '../lib-js/loaders.js';
import { Nbsp, Icon } from '../lib-js/htmlhelper.js';
...
import { mergePoint, checkGrey } from '../lib/incremental.js';

import Alert from 'react-bootstrap/Alert'
import Button from 'react-bootstrap/Button'

import { PilotList, Details } from '../lib/pilotlist.js';
...
//        <>
  //          <div style={{position:'absolute',width:'50%',left:'25%',top:'25%',zIndex:10}}>
    //            <AlertDisconnected mutatePilots={()=>{setSocketUrl('');setPilots(pilots);}} attempt={attempt}/>
      //      </div>
...
//        </>,
   ...
   ` | <a href='#' title='number of viewers'>${wsStatus.c} 👥</a> | <a href='#' title='number of planes currently tracked'>${wsStatus.p} ✈️  </a>`, [connectionStatus,Math.round(wsStatus.at/60)] );
