	...
	if( pilot.legs ) {
		...
		legs = <>
				   <table className="legs">
					   <thead>
						   <td>Tracked Leg</td>
						   { _map( pilot.legs, (x) => x.leg > 0 ? <td>{x.leg} {legIcon(x.leg)}</td> : null )}
					   </thead>
					   <tbody>
					   <tr>
						   <td>Leg Speed</td>
					   ...
					   <tr>
						   <td>Leg Remaining</td>
						   { _map( pilot.legs, (x) => x.leg > 0 ? <td>{x.remaingdistance||''}</td> : null )}
					   </tr>
					   <tr>
						   <td>Task Speed</td>
					   ...
					   <tr>
						...
						<tr>
							...
							{ _map( pilot.legs, (x) => x.leg == pilot.lasttp ? <td>{pilot.remaining||''}</td> : <td/> )}
						</tr>
					   }
					   </tbody>
				   </table>
