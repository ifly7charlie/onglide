...
export default function MApp(props) {
	...
	useMemo( _ => {
		if( props.selectedPilot && props.selectedPilot.lat && 'lasttp' in props.selectedPilot && props.selectedPilot.follow ) {
	...
	const [trackLineStyle,turnpointStyle] = useMemo( _ => {
		return [
			{ // Track line
				id: 'track',
				type: 'line',
				...
				id: 'tp',
				 ...
				 paint: {
					 'fill-extrusion-color': [
						...
						['<', ['get', 'leg'], (props.selectedPilot?.lasttp||0)], 'green',
					 ...
					 'fill-extrusion-base': [
						...
						['<', ['get', 'leg'], (props.selectedPilot?.lasttp||0)], 5,
					 ...
					 'fill-extrusion-height': [
						...
						['<', ['get', 'leg'], (props.selectedPilot?.lasttp||0)], 9,
	...
	}, [ props.selectedPilot, props.selectedPilot?.lasttp, Math.trunc(props.t/60) ]);
		...
		<DeckGL
			...
			layers={layers}>
				...
				<StaticMap          mapboxApiAccessToken={process.env.NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN}
									mapStyle={props.options.mapType % 2 ? "mapbox://styles/ifly7charlie/ckck9441m0fg21jp3ti62umjk" : "mapbox://styles/ifly7charlie/cksj3g4jgdefa17peted8w05m" }
									onLoad={onMapLoad}
									ref={props.mapRef}
