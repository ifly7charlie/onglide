...
export let referenceDate = getNow() - (getNow() % aFewDays) - aFewDays;
...
export function setReferenceDate(epochBase: number) {
    referenceDate = epochBase - (epochBase % aFewDays) - aFewDays;
}
