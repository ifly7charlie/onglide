...
export function capturePossibleLaunchLanding(id, at, point, agl, db, type) {
...
export async function checkForOGNMatches(classid, date, mysql) {
        ...
        myInterface.on('line', (line) => {
            ...
            if (epochbase && (matches = line.match(brecord))) {
                ...
                if (distance(jPoint, location.point, {units: 'kilometers'}) < 20) {
                    ...
                    capturePossibleLaunchLanding(key, time, jPoint, alt - location.altitude, mysql, 'igc');
                }
            }
