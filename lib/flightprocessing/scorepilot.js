...
//		tracker.firstOldPoint = points.length-1;
    ...
    if( findStart( tracker, data.state[compno], task.legs, data.points[compno] )) {
		console.log( "full rescore for ", compno );
		tracker.firstOldPoint = data.points[compno].length-1;
	}
